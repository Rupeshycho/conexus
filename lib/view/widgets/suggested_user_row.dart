// lib/view/widgets/suggested_user_row.dart
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

import '../../viewmodel/suggested_users_viewmodel.dart';

class SuggestedUserRow extends StatefulWidget {
  ...
  @override
  State<SuggestedUserRow> createState() => _SuggestedUserRowState();
}

class _SuggestedUserRowState extends State<SuggestedUserRow> {
  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<SuggestedUsersViewModel>().loadSuggestedUsers(
